            ...
            <div className="main">
                ...
                <div className="point-table">
                    ...
                    <div className="semi-table">
                        ...
                        <div className='mx-2'>
                            <div style={{ color: '#A45EDA', fontWeight: 'bold', fontSize : '20px'}} className="point">{Attempted.toFixed(2)}%</div>
                            <div className="point-info" style={{fontFamily: 'Nunito', fontWeight: 'bold'}}>
                                Attempted
                            </div>
                        </div>
                    </div>
                    <div className="semi-table" >
                        <div style={{ backgroundColor: '#A45EDA' }} className="circle" ></div>
                        <div className='mx-2'>
                            <div style={{ color: '#A45EDA',fontWeight: 'bold', fontSize : '20px' }} className="point">{total_que}</div>
                            <div className="point-info" style={{fontFamily: 'Nunito', fontWeight: 'bold'}}>
                                Total Questions
                            </div>
                        </div>
                    ...
                    <div className="semi-table">
                        ...
                        <div className='mx-2'>
                            <div style={{ color: 'rgb(6 143 86)',fontWeight: 'bold', fontSize : '20px' }} className="point">{correct_que}</div>
                            <div className="point-info" style={{fontFamily: 'Nunito', fontWeight: 'bold'}}>
                                Correct
                            </div>
                        </div>
                    ...
                    <div className="semi-table">
                        ...
                        <div className='mx-2'>
                            <div style={{ color: 'rgb(223 75 75)', fontWeight: 'bold', fontSize : '20px'}} className="point">{wrong_que}</div>
                            <div className="point-info" style={{fontFamily: 'Nunito', fontWeight: 'bold'}}>
                                Wrong
                            </div>
                        </div>
